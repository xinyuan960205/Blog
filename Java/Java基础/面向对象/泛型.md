...
那现在咋办？？？我们是不清楚List集合装载的元素是什么类型的，`List<Object>`这样是行不通的……..**于是Java泛型提供了类型通配符  ?**
...
那么这个Comparator的选择就有很多了，**它可以是`Comparator<String>`，还可以是类型参数是String的父类，比如说`Comparator<Object>`**….
...
![](https://raw.githubusercontent.com/xinyuan960205/pic_resource/master/img/%E6%B3%9B%E5%9E%8B%E5%BA%94%E7%94%A8.png)
